...
int main() {
    ...
    basic.place_tower(1, 1, TowerType::Basic);
    print_result("one_basic_seed0", estimate_defense_capacity(basic, cfg));

    TDEngine mixed(11, 11, 0);
    mixed.place_tower(1, 1, TowerType::Basic);
    mixed.place_tower(5, 4, TowerType::Sniper);
    print_result("basic_sniper_seed0", estimate_defense_capacity(mixed, cfg));
